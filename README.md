...
This will make the file size to reduce, but leave the dimensions and quality just as good.
...
please feel free to open an issue here in repo or shoot an email over
to help@imgbot.net
...
All the code for Imgbot is available on GitHub. We will gladly accept contributions for the services, the website, and the documentation. This is where you can find out how to get set up to run locally as well as detailed information on exactly how an Imgbot works.
